/**
 * v0 by Vercel.
 * @see https://v0.dev/t/YsYwh9u3KHq
 */
    ...
    <section className="mx-auto px-4 md:px-6 max-w-2xl grid gap-12">
      ...
      <div className="grid gap-4">
        <div className="flex justify-between items-center">
          ...
          <span className="text-sm text-zinc-500 dark:text-zinc-400">Read on 10/10/2023</span>
        </div>
        <p className="text-sm leading-loose text-zinc-500 dark:text-zinc-400">
          Key Takeaway: Understand the two systems that drive the way we think—System 1, which is fast and intuitive,
          and System 2, which is slow and deliberate.
        </p>
        <div className="flex items-center gap-0.5 ml-auto">
          <svg
            className=" w-5 h-5 fill-primary"
